...
* link:https://googlecloudplatform.github.io/spring-cloud-gcp/4.8.5/reference/html/index.html[Spring Framework on Google Cloud 4.8.4 (Latest)] - https://googleapis.dev/java/spring-cloud-gcp/4.8.4/index.html[Javadocs 4.8.4]
